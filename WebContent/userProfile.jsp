			...
			<div
				...
				<div style="text-align: left;">
					...
					<div id="msgDetail">
						...
						<input type="hidden" name="password" value='<%=session.getAttribute("psw") %>' />
						<input type="hidden" name="grade" value='<%=session.getAttribute("grade") %>' readonly="readonly" />
						<input type="hidden" name="score" value='<%=session.getAttribute("score") %>' readonly="readonly" />
						<input type="hidden" name="createTime" value='<%=session.getAttribute("createTime") %>' readonly="readonly" />
						<input type="hidden" name="updateTime" value='<%=session.getAttribute("updateTime") %>' readonly="readonly"/>
						<input type="hidden" name="userId" value='<%=session.getAttribute("userId") %>' readonly="readonly"/>
						<input type="hidden" name="headImgUrl" value='<%=session.getAttribute("headImgUrl") %>' readonly="readonly"/>
...
<!-- 						select img to set headImg<input type="file" name="imgFile" /> -->
