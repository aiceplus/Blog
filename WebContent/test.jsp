...
// 									out.println("<a href='bigPhoto.jsp?photoId=" + photo.getId() + "&currentPhoto=" + photo.getUrl() + "&currentIndex=" + index + "'><img alt='click to view big'" +  " src='"+ photo.getUrl() +"' style='width:128px; height:128px' /></a>");
									out.println("<img alt='view photo' " + "layer-src='" + photo.getUrl() +  "' src='"+ photo.getUrl() +"' style='width:128px; height:128px' />");
									out.println("</td>");
								}else{
									out.println("<td style='width:25%'>");
// 									out.println("<a href='bigPhoto.jsp?photoId=" + photo.getId() + "&currentPhoto=" + photo.getUrl() + "&currentIndex=" + index + "'><img alt='click to view big'" +  " src='"+ photo.getUrl() +"' style='width:128px; height:128px' /></a>");
									out.println("<img alt='view photo' " + "layer-src='" + photo.getUrl() + "' src='"+ photo.getUrl() +"' style='width:128px; height:128px' /></a>");
									out.println("</td>");
								}
...
;!function(){
	...
	layer.tips('试试相册模块？', '#div_photo', {tips: 1});
	});
}();
function checkUser(){
	var name = '<%=name%>';
